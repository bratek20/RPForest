...
\chapter{Realistyczny rendering}
    ...
    \section{Path tracer}
        ...
        \textbf{TODO(czy jeszcze coś tu cytować, sama technika jest ogólnie znana, a wzór pewnie nie został wymyślony w PBRT)} 
...
\chapter{Poradnik użytkowania}
    ...
    \section{Uruchomienie programu}
        Program powinien być uruchamiany na systemie operacyjnym \textit{Linux}.
        Repozytorium można sklonować z adresu: \url{https://github.com/bratek20/RPForest}.
        \textbf{TODO podać wymagane biblioteki do zainstalowania}
        
        W celu kompilacji programu należy uruchomić skrypt \textit{build.sh} w głównym katalogu. Skrypt tworzy folder \textit{build}, który posłuży jako miejsce dla plików programu \textit{cmake}. Dodatkowo w folderze \textit{bin} pojawi się plik binarny do uruchamiania programu -- \textit{rpforest.exe}. Należy uruchomić go z linii poleceń. Program posiada dwa opcjonalne argumenty wywołania. 
    ...
    \section{Pliki konfiguracyjne}
        ...
        \textbf{TODO spis wszystkich symboli}
...
\chapter{Szczegóły programistyczne}
    \section{Wykaz użytych narzędzi}
        ...
        Path tracer korzysta z biblioteki \textbf{Embree3}. Pozwala w bardzo szybki sposób obliczać przecięcia promieni z trójkątami, co jest kluczowym elementem path tracingu. 
        
        Do tworzenia obrazów w formacie \textit{.exr} wykorzystana została biblioteka \textbf{OpenEXR}. Pliki w tym formacie można wyświetlić np. przy pomocy programu \textit{exrdisplay}. 
